...
const selectAllBtn = document.querySelector('#allCoursesBtn');
...
function listCseCourses() {
    ...
    listAllCourses(cseCourses);
}

function listWddCourses() {
    let wddCourses = courses.filter(course => course.subject === 'WDD');
    console.log(wddCourses);
    listAllCourses(wddCourses);
}

listAllCourses(courses);

selectAllBtn.addEventListener('click', () => listAllCourses(courses));
selectCseBtn.addEventListener('click', () => listCseCourses());
selectWddBtn.addEventListener('click', () => listWddCourses());